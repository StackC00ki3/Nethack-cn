...
POTION("sleeping",       "effervescent", "沉睡", "沸腾的",  1, 0, 40, 100, CLR_GRAY,
                                                        POT_SLEEPING),
POTION("full healing",          "black", "完全治愈", "黑色",  1, 0, 10, 200, CLR_BLACK,
                                                        POT_FULL_HEALING),
...
POTION("sickness",              "fizzy", "疾病", "起泡的",  0, 0, 40,  50, CLR_CYAN,
                                                        POT_SICKNESS),
POTION("fruit juice",            "dark", "果汁", "深色",  0, 0, 40,  50, CLR_BLACK,
                                                        POT_FRUIT_JUICE),
POTION("acid",                  "white", "酸", "白色",  0, 0, 10, 250, CLR_WHITE,
                                                        POT_ACID),
...
SPELL("create monster",  "turquoise", "制造怪物", "蓝绿色",
      P_CLERIC_SPELL,      35,  3, 2, 1, NODIR, CLR_BRIGHT_CYAN,
                                                        SPE_CREATE_MONSTER),
SPELL("detect food",     "cyan", "探测食物", "青色",
...
SPELL("charm monster",   "magenta", "魅惑怪物", "洋红色",
      P_ENCHANTMENT_SPELL, 20,  3, 5, 1, IMMEDIATE, CLR_MAGENTA,
                                                        SPE_CHARM_MONSTER),
SPELL("haste self",      "purple", "自我加速", "紫色",
...
GEM("dilithium crystal", "white", "双锂水晶", "白色",  2, 1, 4500, 15,  5, GEMSTONE, CLR_WHITE,
                                                        DILITHIUM_CRYSTAL),
MARKER(FIRST_REAL_GEM, DILITHIUM_CRYSTAL)
GEM("diamond",           "white", "钻石", "白色",  3, 1, 4000, 15, 10, GEMSTONE, CLR_WHITE,
                                                        DIAMOND),
GEM("ruby",                "red", "红宝石", "红色",  4, 1, 3500, 15,  9, GEMSTONE, CLR_RED,
                                                        RUBY),
GEM("jacinth",          "orange", "红锆石", "橙色",  3, 1, 3250, 15,  9, GEMSTONE, CLR_ORANGE,
                                                        JACINTH),
GEM("sapphire",           "blue", "蓝宝石", "蓝色",  4, 1, 3000, 15,  9, GEMSTONE, CLR_BLUE,
                                                        SAPPHIRE),
GEM("black opal",        "black", "黑蛋白石", "黑色",  3, 1, 2500, 15,  8, GEMSTONE, CLR_BLACK,
                                                        BLACK_OPAL),
GEM("emerald",           "green", "祖母绿", "绿色",  5, 1, 2500, 15,  8, GEMSTONE, CLR_GREEN,
                                                        EMERALD),
GEM("turquoise",         "green", "绿松石", "绿色",  6, 1, 2000, 15,  6, GEMSTONE, CLR_GREEN,
                                                        TURQUOISE),
GEM("citrine",          "yellow", "黄水晶", "黄色",  4, 1, 1500, 15,  6, GEMSTONE, CLR_YELLOW,
                                                        CITRINE),
GEM("aquamarine",        "green", "海蓝宝石", "绿色",  6, 1, 1500, 15,  8, GEMSTONE, CLR_GREEN,
                                                        AQUAMARINE),
GEM("amber",   "yellowish brown", "琥珀", "杏色",  8, 1, 1000, 15,  2, GEMSTONE, CLR_BROWN,
                                                        AMBER),
GEM("topaz",   "yellowish brown", "黄宝石", "杏色", 10, 1,  900, 15,  8, GEMSTONE, CLR_BROWN,
                                                        TOPAZ),
GEM("jet",               "black", "黑玉", "黑色",  6, 1,  850, 15,  7, GEMSTONE, CLR_BLACK,
                                                        JET),
GEM("opal",              "white", "蛋白石", "白色", 12, 1,  800, 15,  6, GEMSTONE, CLR_WHITE,
                                                        OPAL),
GEM("chrysoberyl",      "yellow", "金绿玉", "黄色",  8, 1,  700, 15,  5, GEMSTONE, CLR_YELLOW,
                                                        CHRYSOBERYL),
GEM("garnet",              "red", "石榴石", "红色", 12, 1,  700, 15,  7, GEMSTONE, CLR_RED,
                                                        GARNET),
GEM("amethyst",         "violet", "紫水晶", "紫色", 14, 1,  600, 15,  7, GEMSTONE, CLR_MAGENTA,
                                                        AMETHYST),
GEM("jasper",              "red", "碧玉", "红色", 15, 1,  500, 15,  7, GEMSTONE, CLR_RED,
                                                        JASPER),
GEM("fluorite",         "violet", "萤石", "紫色", 15, 1,  400, 15,  4, GEMSTONE, CLR_MAGENTA,
                                                        FLUORITE),
GEM("obsidian",          "black", "黑曜石", "黑色",  9, 1,  200, 15,  6, GEMSTONE, CLR_BLACK,
                                                        OBSIDIAN),
GEM("agate",            "orange", "玛瑙", "橙色", 12, 1,  200, 15,  6, GEMSTONE, CLR_ORANGE,
                                                        AGATE),
GEM("jade",              "green", "翡翠", "绿色", 10, 1,  300, 15,  6, GEMSTONE, CLR_GREEN,
                                                        JADE),
MARKER(LAST_REAL_GEM, JADE)
GEM("worthless piece of white glass", "white", "毫无价值的白色玻璃碎片", "白色",
    77, 1, 0, 6, 5, GLASS, CLR_WHITE, WORTHLESS_WHITE_GLASS),
MARKER(FIRST_GLASS_GEM, WORTHLESS_WHITE_GLASS)
GEM("worthless piece of blue glass", "blue", "毫无价值的蓝色玻璃碎片", "蓝色",
    77, 1, 0, 6, 5, GLASS, CLR_BLUE, WORTHLESS_BLUE_GLASS),
GEM("worthless piece of red glass", "red", "毫无价值的红色玻璃碎片", "红色",
    77, 1, 0, 6, 5, GLASS, CLR_RED, WORTHLESS_RED_GLASS),
GEM("worthless piece of yellowish brown glass", "yellowish brown", "毫无价值的杏色玻璃碎片", "杏色",
    77, 1, 0, 6, 5, GLASS, CLR_BROWN, WORTHLESS_YELLOWBROWN_GLASS),
GEM("worthless piece of orange glass", "orange", "毫无价值的橙色玻璃碎片", "橙色",
    76, 1, 0, 6, 5, GLASS, CLR_ORANGE, WORTHLESS_ORANGE_GLASS),
GEM("worthless piece of yellow glass", "yellow", "毫无价值的黄色玻璃碎片", "黄色",
    77, 1, 0, 6, 5, GLASS, CLR_YELLOW, WORTHLESS_YELLOW_GLASS),
GEM("worthless piece of black glass", "black", "毫无价值的黑色玻璃碎片", "黑色",
    76, 1, 0, 6, 5, GLASS, CLR_BLACK, WORTHLESS_BLACK_GLASS),
GEM("worthless piece of green glass", "green", "毫无价值的绿色玻璃碎片", "绿色",
    77, 1, 0, 6, 5, GLASS, CLR_GREEN, WORTHLESS_GREEN_GLASS),
GEM("worthless piece of violet glass", "violet", "毫无价值的紫色玻璃碎片", "紫色",
 ...
 * (inclusive).
 */
ROCK("luckstone", "gray", "幸运石", "灰色",  0,  10,  10, 60, 3, 3, 1, 10, 7, MINERAL, CLR_GRAY,
                                                                    LUCKSTONE),
ROCK("loadstone", "gray", "负重石", "灰色",  0,  10, 500,  1, 3, 3, 1, 10, 6, MINERAL, CLR_GRAY,
                                                                    LOADSTONE),
ROCK("touchstone", "gray", "试金石", "灰色", 0,   8,  10, 45, 3, 3, 1, 10, 6, MINERAL, CLR_GRAY,
                                                                  TOUCHSTONE),
ROCK("flint", "gray", "打火石", "灰色",      0,  10,  10,  1, 6, 6, 0, 10, 7, MINERAL, CLR_GRAY,
                                                                    FLINT),
